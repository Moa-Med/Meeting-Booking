...
var id = document.form1Name.idName;
var name = document.form1Name.nameName;
var participants = document.form1Name.participantsName;
var length = document.form1Name.lengthName;
var dateS = document.form1Name.dateName;
var hour = document.form1Name.hourName;
var minute = document.form1Name.minuteName; //creating a file.txt out of the folder
...
t.addEventListener('submit', function (e) {
  e.preventDefault(); //Function to append the data in the file 

  append(id.value, name.value, dateS.value, hour.value, minute.value, length.value, participants.value);
  document.getElementById('form1').reset(); //display the confirmation box
...
var append = function append(idValue, idName, dateS, hour, minute, length, participants) {
  var remainderMinute = length % 60;
  var quotientHour = ~~(length / 60);
  var minuteEnd = 30; //appending the data
...
//# sourceMappingURL=/lime.e31bb0bc.js.map